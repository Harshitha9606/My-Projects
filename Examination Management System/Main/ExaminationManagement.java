...
public class ExaminationManagement {
    ...
    private static void manageExams() {
        ...
        if (choice == 1) {
            ...
            resultService.getAllResults().removeIf(r -> r.getExam().getId() == id);
    ...
    private static void viewExams() {
        System.out.println("\n--- Exams ---");
        for (Exam e : examService.getAllExams()) System.out.println(e);
    }

    private static void viewResults() {
        System.out.println("\n--- Results ---");
        for (Result r : resultService.getAllResults()) System.out.println(r);
    }
